          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-2">
            ...
            >
              <div className="max-w-xl lg:max-w-lg">
                <h2 className="text-3xl font-bold tracking-tight text-primary">Kontaktieren Sie uns</h2>
                <p className="mt-4 text-lg leading-8 text-gray-600">
                  Wir sind hier, um Ihnen zu helfen und Ihre Fragen zu beantworten. Wir freuen uns darauf, von Ihnen zu hören.
                </p>
                <dl className="mt-10 space-y-4 text-base leading-7 text-gray-600">
                  <div className="flex gap-x-4">
                    ...
                    <dd>123 Finanzdistrikt<br />Zürich, Schweiz</dd>
                  </div>
                  <div className="flex gap-x-4">
                    <dt className="flex-none">
                    ...
                    <dd><a href="mailto:kontakt@finoplenia.com" className="hover:text-primary">kontakt@finoplenia.com</a></dd>
                  </div>
                  <div className="flex gap-x-4">
                    <dt className="flex-none">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <div className="mt-2.5">
                      ...
                      >
                        ...
                        <option>Private Dienstleistungen</option>
                        <option>Unternehmensdienstleistungen</option>
                        <option>Karrieremöglichkeiten</option>
                      </select>
                    </div>
                  </div>
                  <div className="sm:col-span-2">
