...
export default async function PrivateProperty({ params: { locale } }: Props) {
  const dict = await getDictionary(locale);
  const { hero, services } = dict.private.property;
          ...
          <div className="relative isolate overflow-hidden bg-primary px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-24">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300">
                Contact our property experts today to explore investment opportunities.
              </p>
              <div className="mt-10">
                <Link
                  href={`/${locale}/contact`}
